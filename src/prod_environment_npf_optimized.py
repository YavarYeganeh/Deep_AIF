...
# ALPHA = 0.97 # shouldn't be 1 or 0 as those need some adjustments in the code see Alberto's decision maker # in the class
# reward_multiplier = 14 # based on the set point for 60 KW energy consumption while keeping the throughput # in the class
